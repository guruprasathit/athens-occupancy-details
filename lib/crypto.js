...
// Includes BOTH form-payload keys (used when encrypting on submit)
// AND sheet-header-derived keys (used when decrypting rows read back from the sheet).
export const SENSITIVE_FIELDS = [
  // Form payload keys (encrypt on submit)
  ...
  // Sheet header-derived keys (decrypt on read — "Primary Contact" → primary_contact, etc.)
  'primary_contact', 'primary_whatsapp', 'primary_email',
  'secondary_contact', 'secondary_whatsapp', 'secondary_email',
];
